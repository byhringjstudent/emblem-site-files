...
3. Added pictures to Assets folder for "Branding your Inbox Section:
4. Changed max width, max height for each view such as,
* desktop, size: width: 100% x Height: 150%, spacing top/bottom padding: 10, left/right padding: 10
(spacing consistent across all views), tablet width: 120% x Height: 120%, Mobile: 80% x Height: 80%
